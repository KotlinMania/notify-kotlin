...
kotlin {
    ...
    val xcf = XCFramework("Notify")

    macosArm64 {
        binaries.framework { baseName = "Notify"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Notify"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Notify"
        flattenPackage = "io.github.kotlinmania.notify"
    }

    android {
        namespace = "io.github.kotlinmania.notify"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "notify-kotlin", version.toString())

    pom {
        name.set("notify-kotlin")
        description.set("Kotlin Multiplatform port of notify-rs/notify - Cross-platform filesystem notification library")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/notify-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/notify-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/notify-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/notify-kotlin.git")
        }
    }
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.notify.codeql
