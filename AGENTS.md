...
This file is the quick-reference operating contract for notify-kotlin. The longer
...
notify-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`notify`](https://crates.io/crates/notify). Upstream Rust is the behavioral oracle while the
